...
import { AmazonEBCaseStudyHeroSection } from "./sections/AmazonEBCaseStudyHeroSection/AmazonEBCaseStudyHeroSection";
...
export const AmazonEBCaseStudy = (): JSX.Element => {
  return (
    <main className="relative w-full min-h-screen">
      {/* <ScrollRevealLogo /> */}
      <div className="relative w-full space-y-0">
        <AmazonEBCaseStudyHeroSection />
        <BrandVisionSection />
