...
import { GrasimPulpandFibreCaseStudyHeroSection } from "./sections/GrasimPulpandFibreCaseStudyHeroSection/GrasimPulpandFibreCaseStudyHeroSection";
...
export const GrasimPulpandFibreCaseStudy = (): JSX.Element => {
  return (
    <main className="relative w-full min-h-screen">
      {/* <ScrollRevealLogo /> */}
      <div className="relative w-full space-y-0">
        <GrasimPulpandFibreCaseStudyHeroSection />
        <BrandVisionSection />
