...
import { ShreeRubberWorksCaseStudyHeroSection } from "./sections/ShreeRubberWorksCaseStudyHeroSection/ShreeRubberWorksCaseStudyHeroSection";
  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative w-full space-y-0">
        <ShreeRubberWorksCaseStudyHeroSection />
        <BrandVisionSection />
