  ...
  return (
    <section className="relative w-full bg-white overflow-hidden" data-section="clients">
      ...
      <div className="relative h-[100px] md:h-[200px] w-full">
        {/* Purple Strip 
        {/* <div className="absolute top-[20px] left-0 w-[100%] h-[80px] md:h-[100px] bg-[#6A0DAD] transform -skew-y-3 origin-top-left overflow-hidden -translate-x-[10%] z-20">
        ...
        {/* Black Strip */}
          <div className="absolute sm:top-300 lg:top-[100px] md:top-[100px] left-0 w-full h-[80px] md:h-[100px] bg-[#000000] transform skew-y-3 origin-bottom-left overflow-hidden z-999">
