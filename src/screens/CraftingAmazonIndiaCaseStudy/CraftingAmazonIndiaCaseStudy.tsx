...
import { CraftingAmazonIndiaCaseStudyHeroSection } from "./sections/CraftingAmazonIndiaCaseStudyHeroSection/CraftingAmazonIndiaCaseStudyHeroSection";
...
export const CraftingAmazonIndiaCaseStudy = (): JSX.Element => {
  return (
    <main className="relative w-full min-h-screen">
      {/* <ScrollRevealLogo /> */}
      <div className="relative w-full space-y-0">
        <CraftingAmazonIndiaCaseStudyHeroSection />
        <BrandVisionSection />
