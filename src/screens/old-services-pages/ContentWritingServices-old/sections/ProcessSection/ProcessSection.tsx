  ...
  const processSteps: ProcessStep[] = [
    {
      ...
      description: "We start by identifying your industry competitors and learning everything about them to contrast them with you. We dig in on what's working.",
    ...
    },
    {
      ...
      description: "Post identifying relevant data, keywords, and trends, our team sits and brainstorms content ideas. We make sure they are trendy yet.",
    ...
    },
    {
      ...
      description: "We have all the ideas, what's next. We put them into content buckets that are relevant for you to make sure your brand has the right mix of pieces.",
    ...
    },
    {
      ...
      description: "Then begins the process of drafting pieces. Here, we take care of multiple aspects such as SEO, keyword insertion, and storytelling to craft.",
    ...
    },
    {
      ...
      description: "Writing for the audience begins with understanding what the audience wants to learn and hear. When we study your target audience.",
    ...
    },
    {
      ...
      description: "A brand without a story is a business. We help you transform from a business to a brand that your audience recognizes and recalls.",
