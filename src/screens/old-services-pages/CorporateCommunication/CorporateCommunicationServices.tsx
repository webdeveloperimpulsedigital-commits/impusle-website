...
import { CorporateCommunicationServicesHeroSection } from "./sections/CorporateCommunicationServicesHeroSection";
...
export const CorporateCommunicationServices = (): JSX.Element => {
  return (
    <main className="relative w-full min-h-screen">
      {/* <ScrollRevealLogo /> */}
      <div className="relative w-full space-y-0">
        <CorporateCommunicationServicesHeroSection />
        <BrandVisionSection />
