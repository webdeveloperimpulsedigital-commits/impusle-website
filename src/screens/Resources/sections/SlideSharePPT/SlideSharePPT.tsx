...
const SLIDES: Slide[] = [
  { id: "1", title: "Embracing LGBTQ+ Pride in 2023", image: "/impulse-website/slideshow/ppt1.png", href: "https://www.slideshare.net/theimpulsedigital/lgbtq-pride" },
  { id: "2", title: "How Emotions Drive Advertising", image: "/impulse-website/slideshow/ppt2.png", href: "https://www.slideshare.net/theimpulsedigital/emotional-advertising" },
  { id: "3", title: "Why Employer Branding Matters", image: "/impulse-website/slideshow/ppt3.png", href: "https://www.slideshare.net/theimpulsedigital/employer-branding-plan" },
  { id: "4", title: "Planning to Order from ONDC?", image: "/impulse-website/slideshow/ppt4.png", href: "https://www.slideshare.net/theimpulsedigital/ondc-planning" },
  { id: "5", title: "Apple’s VR: What Changes for Marketers", image: "/impulse-website/slideshow/ppt5.jpg", href: "https://www.slideshare.net/theimpulsedigital/apple-vr-marketing" },
  { id: "6", title: "Father’s Day: Brand Playbook", image: "/impulse-website/slideshow/ppt6.jpg", href: "https://www.slideshare.net/theimpulsedigital/fathers-day-campaign" },
  { id: "7", title: "ONDC: Key Takeaways", image: "/impulse-website/slideshow/ppt7.jpg", href: "https://www.slideshare.net/theimpulsedigital/ondc-report" },
  { id: "8", title: "Best AI Tools for India", image: "/impulse-website/slideshow/ppt8.jpg", href: "https://www.slideshare.net/theimpulsedigital/ai-tools" },
  { id: "9", title: "B2B Entrepreneur’s Guide", image: "/impulse-website/slideshow/ppt9.jpg", href: "https://www.slideshare.net/theimpulsedigital/b2b-guide" },
];
    ...
    <div className="slideshare-page py-5">
      <div className="container">
        ...
        <div className="text-center mb-12 lg:mb-16 lg:mt-16">
          ...
          {/* Right: sidebar */}
          <aside className="col-lg-3 mt-5 mt-lg-0 pt-16">
